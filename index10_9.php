...
Function makeAHand($numOfPlayers,$handSize, $numDecks, $deck){
...
//defines a global array with cards to pull
makeAHand($_POST['numPlayers'],$_POST['roundNum']+2,$_POST['numDecks'],$deck)
